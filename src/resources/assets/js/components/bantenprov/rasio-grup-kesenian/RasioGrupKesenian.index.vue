    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <vuetable ref="vuetable"
          api-url="/api/rasio-grup-kesenian"
          :fields="fields"
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/rasio-grup-kesenian/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/rasio-grup-kesenian/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/rasio-grup-kesenian/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/rasio-grup-kesenian/' + rowData.id)
